...
cards=''.join(f'<a class="map-card" href="{prefix}_Chapter{i:02d}.html"><small>MODULE {i:02d} · {"PART I" if i<=6 else "PART II"}</small><h3>{c[0]}</h3><p>{c[2]}</p><span>開始本模組 →</span></a>' for i,c in selected_modules)
